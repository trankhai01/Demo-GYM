...
function viewModel(settings) {
    ...
    out.bank_bin = String(out.bank_bin || '').trim().toLowerCase();
    out.bank_account = normalizePhone(out.bank_account);
    out.bank_account_name = String(out.bank_account_name || '').trim();
    return out;
}
