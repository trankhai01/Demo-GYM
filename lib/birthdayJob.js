...
/* Tạo mã + gửi email cho 1 hội viên cụ thể, nếu sinh nhật rơi vào tháng hiện tại.
   Dùng khi HV vừa cập nhật birth_date qua /my-profile hoặc admin sửa qua /members/edit. */
        ...
        db.query(
            ...
            (err, rows) => {
                ...
                if (!rows || rows.length === 0) {
                    /* HV không tồn tại, không phải member, hoặc sinh nhật khác tháng */
                ...
                db.query(
                    ...
                    (insErr, result) => {
                        ...
                        if (result.affectedRows === 0) {
                            /* Đã có mã từ trước → không gửi lại */
